...
(function() {
  ...
  braintreeName = function(name) {
    return "input[data-braintree-name=" + name + "]";
  };

  $(function() {
    return $('form#checkout_form_payment').submit(function(event) {
      var braintreeClient, card;
      if ($(this).data('submitting')) {
        ...
        braintreeClient.tokenizeCard(card, (function(_this) {
