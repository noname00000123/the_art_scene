      ...
      class Searchkick < Spree::Core::Search::Base
        ...
        def retrieve_products
          ...
          unless Spree::Config.show_products_without_price
            ...
            # @products.by_store(@properties[:current_store_id] || Spree::Store.current.id)
            # TODO nasty hack lets just get this working
          ...
          if @properties[:query].present?
            ...
            # # TODO include associations https://github.com/ankane/searchkick/issues/344
            # # include: [:, :brand]
        ...
        def retrieve_products_autocomplete
          ...
          # @products = get_base_scope
          Spree::Product.search(@properties[:query], fields: [:name], limit: 10).records.map(&:name)
        ...
        def get_base_scope
          # TODO this was the problem, Spree::Product.active returns 1500 rather than 300
          base_scope = @cached_product_group ? @cached_product_group.products.active : Spree::Product.all
