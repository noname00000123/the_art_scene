...
Spree.config do |config|
  ...
  config.company                      = false # Spree::Store.current.code =~ /as|aas/ ? false : true
  config.currency                     = 'AUD'
  ...
  # Set in ApplicationController before_filter
  ...
  # TODO is this the cause for duplicated products
