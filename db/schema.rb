...
ActiveRecord::Schema.define(version: 20150814184307) do
  ...
  create_table "spree_interest_groups", force: :cascade do |t|
    t.integer "user_id"
    t.integer "interest_id"
  end

  create_table "spree_interests", force: :cascade do |t|
    t.string "interest"
  end
